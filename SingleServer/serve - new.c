...
int next_event_type, num_custs_delayed, num_events,
    num_in_q, server_status;
float area_num_in_q, area_server_status, mean_interarrival, mean_service, sim_time,
    time_arrival[Q_LIMIT + 1], time_end, time_last_event , time_next_event[4], total_of_delays;
FILE *infile, *outfile;
...
void initialize(void) /* Initialization function. */
{
    ...
    time_next_event[2] = 1.0e+30; // C Notation for 10^30
...
void report(void) /* Report generator function. */
{
    ...
    fprintf(outfile, "Number of delays completed%7d", num_custs_delayed);
}
...
main () /* Main function */
{
    ...
    fprintf(outfile, "Single-server queuing system with fixed run");
